        ...
        <Document>
          ...
          <Text :style="styles.subtitle">
            ...
            <Text style="text-align: left"
              ...
              <Span style="color: red; font-size: 40px">ssss</Span>
              ...
              <Span
                ...
                >.</Span
              >
              quiso aguardar más tiempo a poner en efeto su pensamiento,
              apretándole a ello la falta que él pensaba que hacía en el mundo
              su tardanza, según eran los agravios que pensaba deshacer, tuertos
              que enderezar, sinrazones que emendar y abusos que mejorar y
              deudas que satisfacer. Y así, sin dar parte a persona alguna de su
              intención y sin que nadie le viese, una mañana, antes del día, que
              era uno de los calurosos del mes de Julio, se armó de todas sus
              armas, subió sobre Rocinante, puesta su mal compuesta celada,
              embrazó su adarga, tomó su lanza y por la puerta falsa de un
              corral salió al campo con grandísimo contento y alborozo de ver
              con cuánta facilidad había {{ title }}
            </Text>
            <!--        <Text>
            ...
            su curiosidad y desatino en esto, que vendió muchas hanegas de tierra de sembradura, para
            ...
            de Silva: porque la claridad de su prosa, y aquellas intrincadas razones suyas, le parecían
          </Text>
          <Text :style="styles.text">
...
import type { Size } from "~/components/Elements/PDF";
defineOptions({
  components: {},
});
const { download } = usePDF();
const title = ref("Amir");
const sizePage = ref<Size>("A4");
const pageNames = ["A4", "Letter", "Legal", "Tabloid", "Carta", "Oficio"];
