...
import { PDF, Text, Page, Document, Image, Span, StyleSheet } from "@pdf.js/vue";
import type { Size } from "@pdf.js/vue/elements/PDF";
import { usePDF } from "@pdf.js/vue"
defineOptions({
  components: {},
});
